    ...
    */
    public function postProcess()
    {
        if (Tools::isSubmit('submitMessage')) {
            ...
            } else if (!($contact_nom = trim(Tools::getValue('contact_nom'))) || (!($contact_nom = nl2br2($contact_nom)))) {
					$this->errors[] = Tools::displayError('Veuillez renseigner votre nom.');
				} else if (!($contact_prenom = trim(Tools::getValue('contact_prenom'))) || (!($contact_prenom = nl2br2($contact_prenom)))) {
  					$this->errors[] = Tools::displayError('Veuillez renseigner votre prénom.');
  				} else if (!($contact_tel = trim(Tools::getValue('contact_tel'))) || (!($contact_tel = nl2br2($contact_tel)))) {
  					$this->errors[] = Tools::displayError('Veuillez renseigner votre téléphone.');
  				}else {
    ...
    */
    public function initContent()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'contact_nom'=>Tools::getValue('contact_nom'),
    			'contact_prenom'=>Tools::getValue('contact_prenom'),
    			'contact_tel'=>Tools::getValue('contact_tel')
        ));
