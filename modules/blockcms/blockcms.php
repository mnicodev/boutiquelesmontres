...
class BlockCms extends Module
{
	...
	/* hook home tab content pour net-concept */
	public function hookDisplayHome($params) {
		$this->smarty->assign("content",new CMS(6));
		$this->smarty->assign("id_lang",$params["cookie"]->id_lang);
		return $this->display(__FILE__, 'blockcms_savoir_faire.tpl', $this->getCacheId($column));
	}
