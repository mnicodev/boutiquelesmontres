...
<div id="wishlist_block" class="block account">
	...
	<div class="block_content">
		...
		<div id="wishlist_block_mng">
				<p class="center">
					<a href="{$wishlist_link|escape:'htmlall':'UTF-8'}" class="{if $themeChoice eq 0}exclusive_large{else}btn btn-default button button-small{/if}" title="{l s='Manage my list(s)' mod='blockwishlistpro'}"><span>{l s='Manage my list(s)' mod='blockwishlistpro'}{if $themeChoice neq 0}<i class="icon-chevron-right right"></i>{/if}</span></a>
				</p>
		</div>
			{if $wishlists}
				<div id="wishlist_block_view">
					<p>
