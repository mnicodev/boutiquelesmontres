CREATE TABLE IF NOT EXISTS `PREFIX_wishlist_pro` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_wishlist_email_pro` (
  `id_wishlist` int(10) unsigned NOT NULL,
  `email` varchar(128) character set utf8 NOT NULL,
  `date_add` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `PREFIX_wishlist_product_pro` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_wishlist_product_cart_pro` (
...
CREATE TABLE IF NOT EXISTS `PREFIX_wishlist_send_pdf_pro` (
  `id_wishlist` int(10) unsigned NOT NULL,
  `id_order` int(10) unsigned NOT NULL,
  `date_send_pdf` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `PREFIX_wishlist_automatic_sending_pro` (
`automatic` int(10) unsigned NOT NULL ,
`copy` int(10) unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO  `PREFIX_wishlist_automatic_sending_pro` (
`automatic` ,
`copy`
)
VALUES (
