			...
			<div class="clearfix">
				<div class="col-xs-12 col-md-12">
					...
					<div class="form-group col-md-6">
						<div class="cadre">
							<label for="nom">{l s='Nom'} : <sup>*</sup></label>
							<input class="form-control grey" type="text" id="nom" name="contact_nom" class="text1" value="{$contact_nom}" />
						</div>
					</div>
					<div class="form-group col-md-6">
						<div class="cadre">
							<label for="contact_prenom">{l s='Prenom'} : <sup>*</sup></label>
							<input class="form-control grey" type="text" id="contact_prenom" name="contact_prenom" class="text1" value="{$contact_prenom}" />
						</div>
					</div>
					...
					<div class="form-group col-md-6">
						<div class="cadre">
						<label for="tel">{l s='Telephone'} : <sup>*</sup></label>
						<input class="form-control grey" type="text" id="tel" name="contact_tel" class="text1" value="{$contact_tel}" />
						</div>
					</div>
