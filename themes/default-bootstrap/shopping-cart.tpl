				...
				{if $use_taxes}
					{if $priceDisplay}
						<tr class="cart_total_price">
							...
							<td colspan="1" class="text-right" style="width:150px">{if $display_tax_label}{l s='Total products (tax excl.)'}{else}{l s='Total products'}{/if}</td>
					...
					{else}
						<tr class="cart_total_price">
							...
							<td colspan="{$col_span_subtotal}" class="text-right" style="width:150px">
								{l s='Total products'}
