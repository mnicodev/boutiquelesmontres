...
{if !isset($errors) OR !sizeof($errors)}
	...
	<div class="voir-tous">
	<!--<a class="btn-noir-light" href="{$base_dir}{$cat->link_rewrite[2]}-{$cat->id}#/fabricant-{$manufacturer->name|lower|replace:' ':'_'}">-->
	<a class="btn-noir-light" href="#all-product" onclick="$('li.product-hidden').show()">
	{if $type=="montre"}
